...
Join the workshop session with the following (Zoom link)[zoom link] [4]. Please make sure to log-in with the name you have used for the registration. For the safety reasons, people who cannot be recognised by the zoom user name will not be let into the workshop.
